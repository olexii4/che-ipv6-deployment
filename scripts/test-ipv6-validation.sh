...
echo -e "${BLUE}Devfile Server (IPv6):${NC}"
...
echo -e "${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "${BLUE}Test via Swagger (POST /dashboard/api/data/resolver):${NC}"
echo "  Node.js: {\"url\": \"http://[${DEVFILE_IPV6}]:8080/nodejs/devfile.yaml\"}"
echo "  Python:  {\"url\": \"http://[${DEVFILE_IPV6}]:8080/python/devfile.yaml\"}"
echo ""
